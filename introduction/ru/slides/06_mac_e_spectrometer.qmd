---
title: "Прямое измерение массы нейтрино. <br> MAC-E-спектрометр"
lecture-id: "06"
lecture-number: 6
...
B(t)\equiv B(\mathbf R(t)),
\qquad
\omega_c(t)=\frac{|q|B(t)}{m}.
$$

- $\mathbf R(t)$ — положение направляющего центра.

- Проверим, сохраняется ли действие:
...
::: {.marginnote .note-right .absolute top=615 left=175 width=350 style="--note-font-size: 0.62em; --note-math-font-size: 1em;"}
<span class="note-title">Цепное правило</span>

$$
\dot{\omega}_c = \frac{d\omega_c}{dt}=\frac{d\omega_c}{ds}\dot{s}
$$
:::
...
- Усредняя $\dot E_\perp=m\omega_c\dot\omega_c Q^2$, находим
...
#### Область между поясами

- Плазмосферный шум — электромагнитные колебания плазмы, которые постепенно меняют направление движения электронов. Часть электронов уходит вдоль магнитных силовых линий в атмосферу. Поэтому между внутренним и внешним радиационными поясами возникает область с пониженной плотностью электронов.
...
- Рассмотрим силовую линию диполя. $R_\oplus$ — радиус Земли, а
...
::: {.marginnote .note-right .absolute top=270 left=1520 width=400 style="--note-font-size: 0.60em; --note-math-font-size: 0.95em;"}
<span class="note-title">Конус потерь:</span>
