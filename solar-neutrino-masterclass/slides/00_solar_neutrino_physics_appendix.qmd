...
![](../assets/figures/pp_chain_map.svg){.slide-image-center .nostretch fig-align="center" width="80%"}
...
uses the same PEANUTS calculation at selected $E_\nu$ and $\eta$ values while scanning
$(\sin^2\theta_{12},\Delta m^2_{21})$.
